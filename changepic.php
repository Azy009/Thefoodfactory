...
<body>
  ...
  <div class="twoo">
    ...
    <div class="change" style="width: 400px;height:170px;background-color:teal;margin:160px 0px 0px 400px;">
        ...
        <div class="change">
            <label for="imgsss"style="text-align:center;margin-left:50px;font-size:32px;padding-bottom:7px;">SELECT PROFILEPIC</label><br>
  ...
  if(isset($_POST['submit'])){
   ...
   $sqlo = "INSERT INTO changeimg(username,img) VALUES('{$abc}','{$name}')";
