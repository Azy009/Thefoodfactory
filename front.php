...
<body>
    ...
    <div class="header">
         ...
         <h1 style="font-size:34px;"><i class="fa-solid fa-utensils"></i>FOOD FACTORY</h1>
    ...
    <div class="content1">
        ...
        <div class="content2" >
            <div class="menu"style="margin-right:37px;">
                <ul style="margin-left: 80px;">
                    ...
                    <li><a href="#contactuss" style="margin-right:15px;">CONTACT</a></li>
                </ul>
            </div>
            ...
            <div class="section" style="margin-left: 5px;">
                ...
                <div class="list">
                      ...
                      if(mysqli_num_rows($req) > 0){
                        ...
                        if($id > 1){
                            echo '<li class="select"><a class="select" href="front.php?id='.($id - 1).'"><i class="fa-solid fa-angle-left"></i></a></li>';
                        }
                       for($a = 1;$a <= $total_page;$a++){
                        ...
                        echo '<li class="'.$pageid.'" ><a  href="front.php?id='.$a.'">'. $a .'</a></li>';   
                    }
                    if($total_page > $id){
                        echo '<li class="select" ><a class="select" href="front.php?id='.($id + 1).'"><i class="fa-solid fa-angle-right"></i></a></li>';
                    }
                    }
                    echo "</ul>";
                      ?>
                ...
                <div class="section3" style="margin-left:-20px;">
                   <div class="from">
                       <form action="search.php" method="get">
                        <div>
                            ...
                            <input type="submit" id="submit" name="submit" class="submit1">
                        </div>
                       </form>
                   </div>
                   <div class="dis" id="aboutme">
                       ...
                       <div class="aboutOWNER">OWNER : AJAY</div>
                       <div class="aboutORDER">ORDER STARTS : 400 RS</div>
                       <div class="aboutNUMBER">NUMBER : 5969584373</div>
                       <div class="aboutADDRESS">ADDRESS : Rz -58 uttam nagar</div>
             ...
             <div class="footer">
                ...
                <div class="icon" style="margin-right:37px;">
