...
<body>
  ...
  <div class="twoo">
    ...
    <div class="change" style="width: 400px;height:170px;background-color:teal;margin:160px 0px 0px 400px;">
        ...
        <div class="change">
            <label for="imgsss"style="text-align:center;margin-left:50px;font-size:32px;padding-bottom:7px;">SELECT BACKGROUNDPIC</label><br>
  ...
  if(isset($_POST['submit'])){
    ...
    if(isset($_FILES['filess'])){
        ...
        move_uploaded_file($tem,"backuploding/".$name);
    }

   if(isset($_SESSION['username'])){
       $abc = $_SESSION['username'];
   }
   $sqlo = "INSERT INTO changebackground(username,backimg) VALUES('{$abc}','{$name}')";
