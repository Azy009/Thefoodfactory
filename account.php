...
<body>
    ...
    <div class="header">
         ...
         <h1 style="margin-left:-400px;font-size:34px;"><i class="fa-solid fa-utensils"></i>FOOD FACTORY</h1>
      
        </div>
    </div>
    <div class="contact_me">
        <div class="formm" id="contactuss">
            <div class="contactme"  style="text-decoration: underline;"><h1 style="padding-top: 5px;">CREATE NEW ACCOUNT</h1></div>
            <form action="baccount.php" method="post">
